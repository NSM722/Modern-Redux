...
/**
 * PayLoadAction is a type of function that defines
 * the action types and payloads that are used to 
 * update the state of a Redux store
 */
...
const counterSlice = createSlice({
  ...
  reducers: {
    ...
    // add a specific amount to the count
    // will there have a payload field
